...
|----------|------|-------------|-------------|
- **T20 — Dashboard Detail Views**: ✅ COMPLETE (2026-06-26)
  - Phase 1: Clickable KPI cards with detail view switching + localStorage persistence
  - Phase 2: All 6 views populated with real data from existing snapshot fields
  - Phase 3: Backend APIs for network interfaces, disk volumes, system info, battery health + async frontend loading
  - User follow-up: Apple Silicon battery temp via `ioreg`, improved network connections table
